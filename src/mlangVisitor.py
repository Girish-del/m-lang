...
class mlangVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by mlangParser#exprStmt.
    def visitExprStmt(self, ctx:mlangParser.ExprStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by mlangParser#block.
    def visitBlock(self, ctx:mlangParser.BlockContext):
        return self.visitChildren(ctx)
